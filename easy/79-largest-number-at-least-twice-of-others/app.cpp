...
int dominantIndex(std::vector<int>& nums) {
    ...
    // determine the highest number in vector using *max_element() function in algorithm lib
    int largestElement {*max_element(nums.begin(), nums.end())};
    
    // determine index of the highest number in vector
    while (i < nums.size()) {
